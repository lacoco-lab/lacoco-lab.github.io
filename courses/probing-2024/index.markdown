...
|               |                     | [Scaling monosemanticity](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html) |   | [Maybe the first SAE paper](https://www.alignmentforum.org/posts/z6QQJbtpkEAX3Aojj/interim-research-report-taking-features-out-of-superposition) <br>  [Codebook Features](https://arxiv.org/abs/2310.17230) | Xinting (brief intro) |
